...
async function run(length: number) {
    ...
    for (const move of moves) {
        ...
        updateCanvas(rope, visited);
        await sleep(25);
        const ans = document.getElementById("answer") as HTMLParagraphElement;
        ans.innerHTML = `Visited count: <b>${visited.size}</b>`
    }
